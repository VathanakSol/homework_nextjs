...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Product Website",
    description: "E-Commerce Website",
    images: 'https://th.bing.com/th/id/R.338e9ffb0599f112bbb9c48e05bd1863?rik=JUObSuSRztIgWg&pid=ImgRaw&r=0',
  }
};
        ...
        <div className="flex flex-col justify-between h-[100vh]">
          ...
          <nav className="bg-white border-gray-200 dark:bg-gray-900">
            ...
            <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span className="text-blue-700 self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
            </a>
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
              <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                  <a href="/product" className="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Product</a>
                </li>
                <li>
